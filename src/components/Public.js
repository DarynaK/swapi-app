        ...
        <div className="trails-container">
            ...
            <div className="trails-wrapper">
                ...
                <div className="bike-side">
                    ...
                    <p className="tr-text">
                        Активний відпочинок є специфічним. І це має розуміти кожен учасник атракції. Для безпечного та
                        приємного відпочинку потрібно дотримуватись правил безпеки під час групових та індивідуальних
                        туристичних піших походів. Кожен з учасників має чітко розуміти куди іде, навіщо (ціль та мета)
